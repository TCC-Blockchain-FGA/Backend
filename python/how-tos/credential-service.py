...
async def issue_credential():
    ...
    cred_values_json = json.dumps({
        'name': ['matheus', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], 'phone': ['61912341234', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], 'gender': ['m', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], \
        'dateOfBirth': ['01011999', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], 'address':['Brasilia', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], 'maritalStatus': ['abc', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], \
        'multipleBirth': [False, '5944657099558967239210949258394887428692050081607692519917050011144233115103'], 'contactRelationship': ['a', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], 'contactName': ['mamama', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], \
        'contactPhone': ['61901011010', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], 'contactAddress': ['Brasilia', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], 'contactGender': ['m', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], \
        'languages': ['pt', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], 'preferredLanguage': ['pt', '5944657099558967239210949258394887428692050081607692519917050011144233115103'], 'generalPractitioner': ['abccba', '5944657099558967239210949258394887428692050081607692519917050011144233115103'],
    })
